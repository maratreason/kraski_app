...
import img7 from "../../uploads/image-block/1.jpg";
import img8 from "../../uploads/image-block/6.jpg";
        ...
        <div className={classes.Parallax}>
            <div className={classes.Container}>
                <div className={classes.TextWrapper}>
                    <h2>Краски нашего производства успешно применяются на более 1000 предприятиях РФ и СНГ:</h2>
                    <ul className={classes.UL}>
                        ...
                        <li><Link to="/"><img src={img7} alt=""/></Link></li>
                        <li><Link to="/"><img src={img8} alt=""/></Link></li>
                    </ul>
                </div>
            </div>
        </div>
