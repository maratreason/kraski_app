        ...
        <div className={classes.CenterMenu}>
            <div className={classes.Container}>
                ...
                <div className={classes.CenterMenuContact}>
                    ...
                    <div>
                        <Link className={classes.MenuLinks} to={"/"}><FaPhoneAlt /> +7 342 296 36 77</Link>
                    </div>
                    <div>
                        <Link className={classes.MenuLinks} to={"/"}><FaEnvelope /> sale@kraskichemi.ru</Link>
                    </div>
                </div>
                <div className={classes.CenterMenuContact}>
                    <h4>Розничные продажи:</h4>
                    <div>
                        <Link className={classes.MenuLinks} to={"/"}><FaPhoneAlt /> +7 342 296 35 77</Link>
                    </div>
                    <div>
                        <Link className={classes.MenuLinks} to={"/"}><FaMobile /> +7 912 882 18 31</Link>
                    </div>
                </div>
